...
const Playlist2: VideoComponentType[] = [
  ...
  },
  {
    ...
    title: "The Day the Mountains Moved, We Learned What Silence Really Sounds Like",
    views: "5.8",
    createdDate: "19"
  },
  {
    ...
    title: "The River Carried Secrets No One Was Brave Enough to Remember Forever",
    views: "11.8",
    createdDate: "1"
  },
   {
    ...
    title: "Voices Whisper Softly Through the Walls of Forgotten Dreams and Memories",
    views: "11.8",
    createdDate: "1"
  }
];
  ...
  return (
    <>
      ...
      <PlayListComponent data = {Playlist2} description = "My Favourite Playlist 2"/>
      </div>
    </>
  )
}
